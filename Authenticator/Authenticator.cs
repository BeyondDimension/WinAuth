...
namespace WinAuth
{
    ...
    public abstract class Authenticator : ICloneable
    {
        ...
        public void SetEncryption(PasswordTypes passwordType, string password = null)
        {
            ...
            else
            {
                using (MemoryStream ms = new MemoryStream())
                {
                    ...
                    // encrypt
                    EncryptedData = Authenticator.EncryptSequence(data, passwordType, password, null);
                    PasswordType = passwordType;
        ...
        public bool Unprotect(string password)
        {
            ...
            try
            {
                string data = Authenticator.DecryptSequence(EncryptedData, PasswordType, password, null);
                ...
                if (changed == true)
                {
                    ...
                    using (MemoryStream ms = new MemoryStream())
                    {
                        ...
                        // encrypt
                        EncryptedData = Authenticator.EncryptSequence(encrypteddata, passwordType, password, null);
                    }
                }
