...
/// </summary>
public sealed class WinAuthInvalidConfigDataException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidHMACAlgorithmException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidUserDecryptionException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidMachineDecryptionException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidEnrollResponseException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidTradesResponseException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidSyncResponseException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthEncryptedSecretDataException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthBadPasswordException : WinAuthException
{
...
public sealed class WinAuthInvalidRestoreCodeException : WinAuthInvalidRestoreResponseException
{
...
/// </summary>
public sealed class WinAuthInvalidEncryptionException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthInvalidSecretDataException : WinAuthException
{
...
public sealed class WinAuthBase32DecodingException : WinAuthException
{
...
/// </summary>
public sealed class WinAuthUnauthorisedRequestException : WinAuthInvalidRequestException
{
...
public sealed class WinAuthUnauthorisedSteamRequestException : WinAuthInvalidSteamRequestException
{
